...
# # person class is index 15
# output_predictions = scores[ : , 15, : , : ] > 0.1
...
t_np = output_predictions.numpy() #convert to Numpy array
df = pd.DataFrame(t_np) #convert to a dataframe
df.to_csv('/Users/jin/Desktop/test/testdeeplav.csv',index=False) #save to file
...
display_segmentation(input_image, output_predictions)